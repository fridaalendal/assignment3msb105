...
```{r}
pend_mat(pendle_data_02_24, y = 2002)
...
pendlemat_2002 <- pend_mat(pendle_data_02_24, y = 2002)
...
pendlemat_2002_tab <-
  ...
  flextable::autofit() |>
  flextable::set_caption("Table 12: Pendlematrise år 2002.")
...
```{r}
pend_mat_tab <- function(data, y, caption = NULL) {
  mat <- pend_mat(data, y)
  ...
  flextable::flextable(mat) |>
    ...
    flextable::set_caption(
      if (is.null(caption)) paste0("Pendlematrise år ", y, ".") else caption
    )
}
...
```{r}
pend_mat_tab(pendle_data_02_24, 2005)
```
