...
```{r}
pendle_data_02_24 <- dplyr::bind_rows(
  pend_02_24,  # alle vanlige pendlestrømmer
  total,       # k0000 TotaltBo / TotaltArb
  p_bRALjRAL   # k9999 RAL / RAL
)
...
```{r}
pendle_data_02_24 <- dplyr::bind_rows(
  pend_02_24,  # alle vanlige pendlingsstrømmer
  totalt_arb,  # k0000 – TotaltArb
  totalt_bo    # k0000 – TotaltBo
)
